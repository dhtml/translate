...
class TranslatePage extends AbstractCommand
{
    ...
    {
        $this
            ->setName('translate:pages')
            ->setDescription('Translation all pages');
    }

    protected function fire()
    {
        $this->info("Execute language translation all pages");
        $this->batchTranslatorService->startWithParam("pages");
    }
