...
class TranslateTag extends AbstractCommand
{
    ...
    {
        $this
            ->setName('translate:tags')
            ->setDescription('Translation all tags');
    }

    protected function fire()
    {
        $this->info("Execute language translation all tags");
        $this->batchTranslatorService->startWithParam("tags");
    }
