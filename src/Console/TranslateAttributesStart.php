...
class TranslateAttributesStart extends AbstractCommand
{
    ...
    {
        $this
            ->setName('translate:attributes:start')
            ->setDescription('Build attributes start');
    }

    protected function fire()
    {
        $this->info("Execute language translation all attributes");
        $this->batchTranslatorService->startWithParam("attributes");
    }
